...
<link rel="stylesheet" href="<?php echo e(url('css/geenarmoede.css')); ?>" type="text/css"> 
        ...
        <div class="sdg-content wrapper">
            <div class="sdg-content-wrapper">
                ...
                <div class="sdg-imagebox">
                    <img class="sdg" src="<?php echo e(url('images/sdg1.svg')); ?>">
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.sdg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\colin\Documents\Mediacollege Amsterdam\Bewijzenmap\Leerjaar2\periode4\NVVN\sdggame\resources\views/geenarmoede.blade.php ENDPATH**/ ?>